...
export default function SubmissionContent({
    ...
    fieldGridClassName = 'grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2',
                ...
                <div className="flex items-start px-2">
                    {SECTIONS.map((s, i) => (
                        <React.Fragment key={i}>
                            ...
                            {i < SECTIONS.length - 1 && <div className="bg-border mt-4 h-0.5 flex-1" />}
                        </React.Fragment>
                    ))}
                </div>
            )}
                ...
                <Section title="Occupation & Skills">
                    <div className={fieldGridClassName}>
                        ...
                        <Field
                            ...
                            value={app.apprentice_year ? `Year ${app.apprentice_year}` : 'Not an apprentice'}
                        />
                            ...
                            value={
                                app.medical_condition === 'none' || !app.medical_condition
                                    ...
                                    : app.medical_condition === 'other'
                                      ...
                                      : app.medical_condition.charAt(0).toUpperCase() +
                                        app.medical_condition.slice(1) +
                                        ' condition'
                            }
                        />
                    </div>
