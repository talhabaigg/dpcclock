...
import { CheckCircle2, Fingerprint, LoaderCircle, Lock, Shield, Zap } from 'lucide-react';
...
export default function PasskeyPrompt() {
    ...
    useEffect(() => {
        ...
        if (passkeyPrompt && passkeysSupported && !passkeyPrompt.hasPasskeys && !passkeyPrompt.dismissed && !dismissedThisSession) {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center">Passkeys are a more secure and convenient way to sign in.</DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium">No passwords to steal</p>
                            <p className="text-muted-foreground text-xs">Your passkey uses encryption that never leaves your device.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium">Fast and easy</p>
                            <p className="text-muted-foreground text-xs">Sign in instantly with your fingerprint, face, or device PIN.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-2 border-t pt-4">
                    <Checkbox id="dont-show-again" checked={dontShowAgain} onCheckedChange={(checked) => setDontShowAgain(checked === true)} />
                ...
                <DialogFooter className="flex-col gap-2 sm:flex-col">
                    <Button onClick={handleSetupPasskey} className="w-full" disabled={isRegistering}>
                        {isRegistering ? <LoaderCircle className="mr-2 h-4 w-4 animate-spin" /> : <Fingerprint className="mr-2 h-4 w-4" />}
