...
export function TakeoffPanel({
    ...
    const TABS: { id: TabId; label: string; icon: typeof Ruler; badge?: number }[] = [
        { id: 'takeoff', label: 'Measures', icon: Ruler, badge: measurements.length || undefined },
        { id: 'conditions', label: 'Conditions', icon: Settings, badge: conditions.length || undefined },
    ...
    return (
        <TooltipProvider delayDuration={200}>
            <div className="flex h-full flex-col bg-background text-xs">
                {/* Tab strip — pill-style within muted bar */}
                <div className="flex items-center gap-0.5 border-b bg-muted/40 px-1 py-1">
                    {TABS.map((tab) => {
                        const Icon = tab.icon;
