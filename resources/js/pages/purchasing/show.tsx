            ...
            <div className="space-y-2 p-4">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex w-1/2 justify-end self-start">
                        <Link href={`/requisition/excel/${requisition.id}`} className="mr-2">
                    ...
                    <tbody>
                        {requisition.line_items.map((item) => (
                            <tr key={item.id} className="border-t">
                                ...
                                <td className="p-1 text-left">$ {item.unit_cost.toFixed(2)}</td>
                                <td className="p-1 text-left">$ {item.total_cost.toFixed(2)}</td>
                                <td className="p-1 text-left">{item.cost_code}</td>
                                <td className="p-1 text-left">{item.price_list}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
