...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'SWMS', href: '/swms' }];

export default function SwmsSelectLocation({ locations }: Props) {
    ...
    useEffect(() => {
        ...
        if (saved && locations.some((l) => String(l.id) === saved)) {
            ...
            router.visit(`/locations/${saved}/swms`, { replace: true });
        }
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Select project — SWMS" />
