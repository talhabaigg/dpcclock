    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="p-0">
                <Command>
                    <CommandInput placeholder="Search cost type..." className="h-9" value={search} onValueChange={setSearch} />
                    <CommandList>
                            ...
                            {filteredCostTypes.map((costType) => (
                                ...
                                >
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-muted-foreground text-xs">{costType.description}</span>
                                    </div>
