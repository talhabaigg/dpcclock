            ...
            <div className="flex-1 overflow-y-auto">
                {!task.level && (
                    <div className="flex h-full flex-col items-center justify-center gap-2 p-6 text-center">
                        <ChevronRight className="text-muted-foreground/50 h-8 w-8" />
                        <p className="text-muted-foreground text-base font-medium">Select a level first</p>
                    </div>
                )}

                {task.level && activities.length === 0 && (
                    <div className="flex h-full flex-col items-center justify-center gap-2 p-6 text-center">
                        <p className="text-muted-foreground text-base font-medium">No activities</p>
                    </div>
                )}
