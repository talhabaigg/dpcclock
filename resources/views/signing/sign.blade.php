...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .agreement-body ol[data-list-style="legal"],
        .agreement-body ol[data-list-style="legal"] ol:not([data-list-style="alpha"]) { padding-left: 0 !important; list-style-type: none !important; counter-reset: legal; }
        .agreement-body ol[data-list-style="legal"] ol:not([data-list-style="alpha"]) { margin: 4px 0; }
        .agreement-body ol[data-list-style="legal"] > li,
        .agreement-body ol[data-list-style="legal"] ol:not([data-list-style="alpha"]) > li { counter-increment: legal; position: relative; padding-left: 36px; }
        .agreement-body ol[data-list-style="legal"] > li::before { content: counter(legal) "."; font-weight: 500; position: absolute; left: 0; }
        .agreement-body ol[data-list-style="legal"] ol:not([data-list-style="alpha"]) > li::before { content: counters(legal, ".") "."; font-weight: 500; position: absolute; left: 0; }
        .agreement-body ol[data-list-style="alpha"],
        .agreement-body ol[data-list-style="alpha"] ol:not([data-list-style="legal"]) { list-style-type: lower-alpha; }
