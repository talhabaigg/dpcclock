...
class LoadApPostedInvoiceLines implements ShouldQueue
{
    ...
    {
        \Illuminate\Support\Facades\Log::error('LoadApPostedInvoiceLines: Job failed permanently after all retries', [
    ...
    {
        return 'ap_posted_invoice_lines';
    }
    ...
    {
        return ApPostedInvoiceLine::class;
    }
