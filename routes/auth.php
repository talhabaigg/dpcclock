...
// Passkey authentication routes (from spatie/laravel-passkeys)
Route::passkeys();
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('s/{code}', [\App\Http\Controllers\Auth\SetupLinkController::class, 'redirect'])
        ->where('code', '[A-Za-z0-9]+')
        ->name('setup-link.redirect');
