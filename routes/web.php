...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('permission:form-requests.view')->group(function () {
        Route::get('/form-requests', [FormRequestController::class, 'index'])->name('form-requests.index');
    });
    ...
    Route::post('/signing-requests/bulk-cancel', [SigningRequestController::class, 'bulkCancel'])->name('signing-requests.bulk-cancel');
    ...
    Route::middleware('permission:locations.view')->group(function () {
        ...
        Route::middleware('permission:locations.schedule')->group(function () {
            ...
            Route::get('/locations/{location}/tasks/export-csv', [ProjectTaskController::class, 'exportCsv'])->name('project-tasks.export-csv');
    ...
    Route::patch('/locations/{location}/sell-multiplier', [LocationController::class, 'updateSellMultiplier'])->name('locations.sell-multiplier.update')
        ->middleware('role:admin');
    ...
    // ============================================
    // KIOSK MANAGEMENT (Admin routes - require auth)
    // ============================================
    ...
    Route::post('/kiosks/{kiosk}/sync-employees', [KioskController::class, 'syncEmployeesOnKiosk'])->name('kiosks.syncEmployees')
        ->middleware('permission:kiosks.manage-employees');
    ...
    Route::post('/kiosks/manager/store', [KioskController::class, 'storeManager'])->name('kiosks.manager.store')
        ->middleware('permission:kiosks.manage-managers');
    Route::post('/kiosks/{kiosk}/sync-managers', [KioskController::class, 'syncManagersOnKiosk'])->name('kiosks.syncManagers')
        ->middleware('permission:kiosks.manage-managers');
    ...
    Route::middleware('permission:reports.glBudgetActual')->group(function () {
        ...
        Route::get('/reports/gl-month-summary', [GlMonthSummaryReportController::class, 'index'])->name('reports.glMonthSummary');
        Route::get('/reports/gl-month-summary/pdf', [GlMonthSummaryReportController::class, 'downloadPdf'])->name('reports.glMonthSummary.pdf');
    });
    ...
    Route::middleware('permission:variations.view')->group(function () {
        ...
        Route::get('/locations/{location}/variations/{variation}/show', [VariationController::class, 'locationVariationShow'])->name('locations.variations.show');
    ...
    Route::middleware('permission:drawings.create')->group(function () {
        ...
        // Triage writes a site task, so it sits with drawings.create too.
        Route::post('/drawings/{drawing}/comparison/items/{item}/triage', [DrawingComparisonController::class, 'triage'])->name('drawings.comparison.triage');
    ...
    Route::middleware('permission:takeoff.view')->group(function () {
        ...
        Route::get('/locations/{location}/takeoff-conditions/bulk-export', [TakeoffConditionController::class, 'bulkExport'])->name('takeoff-conditions.bulk-export');
        Route::get('/locations/{location}/takeoff-conditions/bulk-export-detailed', [TakeoffConditionController::class, 'bulkExportDetailed'])->name('takeoff-conditions.bulk-export-detailed');
    ...
    Route::middleware('permission:takeoff.edit')->group(function () {
        ...
        Route::post('/locations/{location}/takeoff-conditions/bulk-import', [TakeoffConditionController::class, 'bulkImport'])->name('takeoff-conditions.bulk-import');
        Route::post('/locations/{location}/takeoff-conditions/bulk-import-detailed', [TakeoffConditionController::class, 'bulkImportDetailed'])->name('takeoff-conditions.bulk-import-detailed');
        ...
        Route::patch('/locations/{location}/master-hourly-rate', [TakeoffConditionController::class, 'updateMasterHourlyRate'])->name('takeoff-conditions.master-hourly-rate.update');
        // Bid areas (write)
    ...
    Route::middleware('permission:prestarts.view')->group(function () {
        ...
        Route::post('/daily-prestarts/{dailyPrestart}/unlock', [DailyPrestartController::class, 'unlock'])->name('daily-prestarts.unlock')
            ->middleware('permission:prestarts.edit');
        Route::get('/daily-prestarts/{dailyPrestart}/pdf', [DailyPrestartController::class, 'downloadPdf'])->name('daily-prestarts.pdf');
